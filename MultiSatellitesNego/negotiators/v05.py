"""
Version 0.5 of the satellite negotiator.

This version is based on v0.3.1
...
class NegotiatorV05(BaseNegotiator):
    """
    Version 0.5 of the satellite negotiator.
    """
    negotiator_issues = [
    ...
    def propose(self, state: SAOState, dest: str | None = None) -> Outcome | None:
        ...
        # Evaluate the task - how much does its reward points "cost"?
        # I.e.: (task memory requirement) / (task reward) = for one reward point, how many menory points I need to pay
        # According the current task creating process, this value rage is 0.1 ~
        task_reward_cost = float(self.task.memory_required / self.task.reward_points)
    ...
    def respond(self, state: SAOState, source: str | None = None) -> ResponseType:
        ...
        # Only accept if it's past the minimum steps and utility is above threshold
