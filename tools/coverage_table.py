...
import json
from MultiSatellitesNego.utils import generate_coverage_markdown_table, generate_coverage_console_table
...
def main():
    ...
    ret = generate_coverage_console_table(sat_list, tsk_list)
    print(f"ret: {ret}")
